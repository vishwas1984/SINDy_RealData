...
from pytorch_forecasting.metrics import NormalDistributionLoss, MultivariateNormalDistributionLoss, MQF2DistributionLoss, QuantileLoss

from .torch_forecast_nn_models import FCN
...
class TorchForecastModel:
    def __init__(self, df, model_name='DeepAR', width=40, lead_time=60, 
        ...
        self.static_categoricals = ['group'] if model_name in ['DeepAR', 'TFT'] else []
        self.target_normalizer = None # None, TorchNormalizer(), EncoderNormalizer()
